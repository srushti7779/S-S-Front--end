...
const MiscAccountPasswordsList = () => {
  ...
  useEffect(() => {
    dispatch(getPasswordFormDeatils("misc-password"));
  }, []);
  return (
    <>
              ...
              {formList?.map((item, index) => (
                <>
                  <div
                    onDoubleClick={() =>
                      router.push(
                        `/home/passwords-forms/misc-account/${item?.id}`
                      )
                    }
                    key={index}
                    // onClick={() => router.push(`/home/passwords/${folders?.navigate}`)}
                              ...
                              <Menu.Item>
                                {({ active }) => (
                                  <p
                                    ...
                                    onClick={() =>
                                      router.push(
                                        `/home/passwords-forms/misc-password/${item?.id}`
                                      )
                                    }
                                  >
                                    Open{" "}
...
export default MiscAccountPasswordsList;
