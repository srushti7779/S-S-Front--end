...
const RecipeAccoutnForm = () => {
  ...
  useEffect(() => {
    dispatch(getPasswordFormDeatils("recipe-account"));
  }, []);
              ...
              {formList?.map((item, index) => (
                <>
                  <div
                    key={index}
                    onDoubleClick={() =>
                      router.push(`/home/passwords-forms/recipe/${item?.id}`)
                    }
                              ...
                              <Menu.Item>
                                {({ active }) => (
                                  <p
                                    ...
                                    onClick={() =>
                                      router.push(
                                        `/home/passwords-forms/recipe-account/${item?.id}`
                                      )
                                    }
                                  >
                                    Open{" "}
...
export default RecipeAccoutnForm;
