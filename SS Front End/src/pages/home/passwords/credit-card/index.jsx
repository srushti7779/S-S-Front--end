...
const CreditCardAccountList = () => {
  ...
  useEffect(() => {
    dispatch(getPasswordFormDeatils("credit-card"));
  }, []);
  return (
    <>
            ...
            <>
              {formList?.map((item, index) => (
                <>
                  <div
                    ...
                    onDoubleClick={() =>
                      router.push(
                        `/home/passwords-forms/credit-card/${item?.id}`
                      )
                    }
              ...
              {allowedList?.map((item, index) => (
                <div
                  key={index}
                  onDoubleClick={() =>
                    router.push(`/home/passwords-forms/credit-card/${item?.id}`)
                  }
                  className="cursor-pointer hover:shadow-lg hover:ring-offset-0 hover:ring-opacity-25 transition-all duration-100 px-5 py-4 max-w-[290px] min-w-[150px] w-full h-[173px] bg-white rounded-[7px] "
                >
                  <div className="w-full flex justify-between items-center">
...
export default CreditCardAccountList;
