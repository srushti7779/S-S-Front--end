...
const NonBankAccountPasswordsList = () => {
  ...
  useEffect(() => {
    dispatch(getPasswordFormDeatils("password-non-bank"));
  }, []);
              ...
              {formList?.map((item, index) => (
                <>
                  <div
                    ...
                    onDoubleClick={() =>
                      router.push(
                        `/home/passwords-forms/non-bank-account/${item?.id}`
                      )
                    }
                    ...
                    <Formik
                      ...
                      onSubmit={(values) => {
                        dispatch(
                          ...
                          .then(() => {
                            dispatch(
                              getPasswordFormDeatils("password-non-bank")
                            );
                            ...
                            <Menu.Item>
                              {({ active }) => (
                                <p
                                  ...
                                  onClick={() =>
                                    router.push(
                                      `/home/passwords-forms/password-non-bank/${item?.id}`
                                    )
                                  }
                                >
                                  Open{" "}
...
export default NonBankAccountPasswordsList;
