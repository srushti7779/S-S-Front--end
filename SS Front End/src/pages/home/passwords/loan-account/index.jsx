...
const LoanAccountPasswordsList = () => {
  ...
  useEffect(() => {
    dispatch(getPasswordFormDeatils("loan-account"));
  }, []);
  return (
    <>
              ...
              {formList?.map((item, index) => (
                <>
                  <div
                    ...
                    onDoubleClick={() =>
                      router.push(
                        `/home/passwords-forms/loan-account/${item?.id}`
                      )
                    }
...
export default LoanAccountPasswordsList;
