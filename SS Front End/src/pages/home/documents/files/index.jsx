...
const FileList = () => {
  ...
  const { fileList, fileLoading } = useSelector((state) => ({
  ...
  return (
    <>
      <div className="absolute top-10 left-[50%]">
        <h1 className="font-semibold text-base xl:text-[31px]">My Files</h1>
      </div>
      <div className="w-full flex justify-center items-start min-h-[85vh]">
        <div className="px-10 max-w-7xl flex flex-col justify-center items-start gap-7 w-full bg-transparent rounded-[20px] mx-auto my-10 relative">
          <div className="w-full flex justify-between items-center">
            <div className="font-semibold text-xl">All Files</div>
            <div></div>
          </div>
